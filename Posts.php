  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <header class="bg-dark text-white py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
          <h1><i class="fas fa-blog" style="color:#27aae1;"></i> Products</h1>
          </div>
          <div class="col-lg-3 mb-2">
            <a href="AddNewPost.php" class="btn btn-primary btn-block">
              <i class="fas fa-edit"></i> Add New Product
            </a>
          </div>
          <div class="col-lg-3 mb-2">
        ...
        <tr>
          ...
          <td>
           ...
           <td>
              ...
              <td>
                <a href="FullPost.php?id=<?php echo $Id; ?>" target="_blank"><span class="btn btn-primary">Details</span></a>
              </td>
                </tr>
                </tbody>
