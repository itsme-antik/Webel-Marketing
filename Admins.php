  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
     ...
     <!-- <div class="collapse navbar-collapse" id="navbarcollapseCMS">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a href="Comments.php" class="nav-link">Reviews</a>
        </li>
        <li class="nav-item">
          <a href="Blog.php?page=1" class="nav-link" target="_blank">Live Sales</a>
        </li>
      </ul>
    ...
    <header class="bg-dark text-white py-3">
      <div class="container">
        <div class="row">
        <!--  <div class="col-md-12">
          <h1><i class="fas fa-user" style="color:#27aae1;"></i> </h1>
          </div> -->
        </div>
      </div>
    </header>
